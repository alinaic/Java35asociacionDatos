...
public static final String SQL_SELECION_PRODUCTOS = "SELECT tabla_productos.id, tabla_productos.nombre, tabla_productos.precio, tabla_productos.id,tabla_categorias.nombre as nombre_categoria FROM tabla_productos,tabla_categorias WHERE tabla_productos.id_categorias = tabla_categorias.id order by tabla_productos.id desc limit ?,? ";
